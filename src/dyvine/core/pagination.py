...
``services/posts.py::PostService._run_bulk_download`` cap their outer
pagination loops with the same heuristic::
...
``partial`` completion via the terminal status branches.
